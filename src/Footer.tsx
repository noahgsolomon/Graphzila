                ...
                <div className="flex flex-col justify-between items-center md:flex-row">
                    <div className={"md:mr-10"}>
                        <div className="flex justify-center md:justify-start cursor-pointer">
                            <img className={'w-[50px] mr-3'} src={'https://img.icons8.com/stickers/100/dragon.png'} alt={'graphzila'}/> <div className={'flex flex-col transition-all hover:text-red-500 dark:hover:text-red-500 text-gray-50 '}><h1 className={'text-4xl'}>Graphzila</h1><p className={'text-sm opacity-60'}>Powered by OpenAI</p></div>
                        </div>
